...
| 
	...
	| <a href="http://www.redeseo.com.br" target="_blank"><strong>REDE SEO</strong></a>
	 ...
	 | Este plugin foi desenvolvido com base nos plugins <strong><a href="http://www.e2solutions.net/articles/important-seo-queries.html" target="_blank">seoqueries</a></strong> e <span mce_style="color: #ff0000;"><strong>F SEO Qrs</strong></span> 
...
function seoqueries_widget_control(){
	...
	echo '<input type="text" name="seoqueries_widget_title" value="'. get_option('seoqueries_widget_title','Rede SEO WP-keywords') .'" />';
	...
	_e('Exibir como texto puro (caso contrário, será exibido como uma lista não-ordenada)');
...
function register_seoqueries_widget() {
    ...
    register_sidebar_widget('Rede SEO WP-keywords', 'seoqueries_widget');



    register_widget_control('Rede SEO WP-keywords', 'seoqueries_widget_control' );
